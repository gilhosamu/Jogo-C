...
void NPCin(bool *done, int *mapa_atual, int *count, int *pos_x, int *pos_y, int *stamina, int *ataque, ALLEGRO_SAMPLE *player_hit, ALLEGRO_SAMPLE *player_hurt, int load_pos, AB *IN1, AB *IN2, AB *IN3, AB *IN4, AB *IN5, AB *IN6, AB *IN7, AB *IN8, AB *IN9, AB *IN10, AB *IN11, AB *IN12, AB *IN13)
{
    ...
    case 9:
        ...
        if((MODULO(inimigo4.x - *pos_x)<30 && MODULO(inimigo4.y - *pos_y)<30) && *ataque == 1 && inimigo4.vidas > 0){inimigo4.vidas = inimigo4.vidas -1; al_play_sample(player_hit,1.0,0.5,1.0,ALLEGRO_PLAYMODE_ONCE, NULL);}
        load_pos = 0;
        if(inimigo1.vidas < 1 && inimigo2.vidas < 1 && inimigo3.vidas < 1 && inimigo4.vidas < 1){*mapa_atual = *mapa_atual +1;*pos_x = 700; *pos_y = 150;}
        break;
    case 10:
        break;
    case 11:
